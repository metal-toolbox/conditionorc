...
import (
	...
	store "github.com/metal-toolbox/conditionorc/internal/store"
...
func (mr *MockRepositoryMockRecorder) Get(ctx, serverID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockRepository)(nil).Get), ctx, serverID)
}
